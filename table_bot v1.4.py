...
import logging # Used to log content
from dotenv import load_dotenv # Allows to load enviorment files
import requests
import json
import random, os 
...
if token is None:
    raise ValueError('DISCORD_TOKEN not found. Check .env file')
client.run(token)
